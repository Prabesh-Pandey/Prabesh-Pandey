...
<!-- Animated Header -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Prabesh%20Pandey&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32&desc=Full%20Stack%20Developer%20|%20Software%20Engineering%20Student&descSize=16&descAlignY=52"/>
...
<!-- Animated Banner -->
<img src="https://i.imgur.com/2yaf2wb.gif" width="500"/>
...
I specialize in crafting **performant web applications** with a focus on clean code architecture and cutting-edge technologies.
...
<!-- What I Do Cards -->
<img src="https://img.shields.io/badge/Currently_Building-Full_Stack_Applications-blueviolet?style=for-the-badge&labelColor=0D1117"/>
<img src="https://img.shields.io/badge/Learning-New_Technologies_Daily-22D3EE?style=for-the-badge&labelColor=0D1117"/>
<img src="https://img.shields.io/badge/I_Love-Solving_Complex_Problems-A855F7?style=for-the-badge&labelColor=0D1117"/>
...
| ------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------- | ------------------------------------------- |
| **[LocalSkillSwap](https://github.com/Prabesh-Pandey/LocalSkillSwap)**                                       | Community skill exchange platform with smart booking, reviews & real-time notifications | `React` `Node.js` `MongoDB` `JWT` `Vite`    |
| **[Task Manager](https://github.com/Prabesh-Pandey/Task-Manager)**                                           | Full-featured task management app with auth, real-time updates & collaboration          | `React` `Node.js` `MongoDB` `Express` `JWT` |
| **[Furniture E-Commerce](https://github.com/Nepal-College-of-Information-Technology/project-work-group-20)** | Modern e-commerce platform with admin dashboard & payment integration                   | `React` `Node.js` `PostgreSQL` `Stripe`     |
| **[Quiz Game](https://github.com/Prabesh-Pandey/Quiz-Game)**                                                 | Interactive quiz app with multiple categories, leaderboards & smooth animations         | `React` `Node.js` `CSS3` `REST API`         |
